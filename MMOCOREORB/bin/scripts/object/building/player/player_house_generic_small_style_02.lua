...
object_building_player_player_house_generic_small_style_02 = object_building_player_shared_player_house_generic_small_style_02:new {
	...
	cityRankRequired = 1,
	publicStructure = 0,
	controlDeviceObject = "object/intangible/house/hcd_generic_small_2.iff",
	skillMods = {
	...
	shopSigns = {
			...
			{templateFile = "object/tangible/sign/municipal/municipal_sign_hanging_university.iff", x = -1.91, z = 2, y = 8.35, ox = 0, oy = -1, oz = 0, ow = 0, cellid = -1, containmentType = -1, requiredSkill = "", suiItem = "@player_structure:university_hanging"},
