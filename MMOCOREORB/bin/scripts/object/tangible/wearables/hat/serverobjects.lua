...
includeFile("tangible/wearables/hat/mask_hendanyn.lua")
includeFile("tangible/wearables/hat/mask_mandalore.lua")
includeFile("tangible/wearables/hat/mask_sith.lua")
