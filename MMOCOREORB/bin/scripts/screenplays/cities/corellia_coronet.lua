...
function CorelliaCoronetScreenPlay:spawnMobiles()
	...
	pNpc = spawnMobile(self.planet, "trainer_surveyor",60,-0.1,0.6,63.1,-179,1855675)
	self:setMoodString(pNpc, "neutral")
	...
	spawnMobile(self.planet, "trainer_surveyor",0,26.676,0.26,5.41823,85,1855531)
	...
	--Meatlump's outside
	spawnMobile(self.planet, "meatlump_buffoon",300,145, 18,-4859.8,63,0)
	spawnMobile(self.planet, "meatlump_buffoon",300,54.3, 0,-4963.4,-90,0)
	spawnMobile(self.planet, "meatlump_buffoon",300,20.1, 0,-4922.2,109,0)
	...
	spawnMobile(self.planet, "meatlump_buffoon",300,-370.1,28,-4923,-97,0)
	spawnMobile(self.planet, "meatlump_clod",300,130.2, 0,-4893.8,72,0)
	...
	spawnMobile(self.planet, "meatlump_cretin",300,56.4, 0,-4985.2,33,0)
	...
	spawnMobile(self.planet, "meatlump_cretin",300,-336.2,28.4,-4947.9,-16,0)
	...
	spawnMobile(self.planet, "meatlump_fool",300,-397.3,28,-4918.8,-86,0)
	spawnMobile(self.planet, "meatlump_fool",300,-357,30,-4968.4,24,0)
	...
	spawnMobile(self.planet, "meatlump_oaf",300,136, 0,-4894.5,83,0)
	spawnMobile(self.planet, "meatlump_oaf",300,72, 0,-4973.1,-77,0)
	...
	spawnMobile(self.planet, "meatlump_stooge",300,133.5, 0,-4894,72,0)
	...
	--Ragtag's outside
	spawnMobile(self.planet, "ragtag_kook",300,-317.315,28,-4927.23,40.3799,0)
	spawnMobile(self.planet, "ragtag_kook",300,-313.219,28,-4926.08,204.867,0)
	spawnMobile(self.planet, "ragtag_kook",300,-325.238,28,-4931.01,254.658,0)
	spawnMobile(self.planet, "ragtag_kook",300,-312.993,28,-4922.77,38.0909,0)
	...
	spawnMobile(self.planet, "trainer_surveyor",0,-33.9759,28,-4435.08,95,0)
