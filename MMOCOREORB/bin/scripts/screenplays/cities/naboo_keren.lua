...
function NabooKerenScreenPlay:spawnMobiles()
	...
	--Med Center
	spawnMobile(self.planet, "trainer_surveyor",0,27.2188,0.26,5.37779,76,1661366)
	spawnMobile(self.planet, "trainer_surveyor",0,-17,0.26,9,180,1661370)
	...
	spawnMobile(self.planet, "trainer_surveyor",0,1927,12,2729.93,264,0)
