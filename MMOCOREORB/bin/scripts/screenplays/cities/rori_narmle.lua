...
function RoriNarmleScreenPlay:spawnMobiles()
	...
	spawnMobile("rori", "trainer_surveyor", 1, -16.4, 0.26, 10.9, 180, 4635424)
	spawnMobile("rori", "trainer_surveyor", 1, 26.6041, 0.26, 5.45989, 83, 4635420)
	...
	spawnMobile("rori", "trainer_scout", 1, -5154, 80.56, -2237, 180, 0)
