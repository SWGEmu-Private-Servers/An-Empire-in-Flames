...
function RoriRestussScreenPlay:spawnMobiles()
	...
	spawnMobile("rori", "trainer_surveyor", 0, -16.3425, 0.26, 10.8489, 168, 4635732)
	spawnMobile("rori", "trainer_surveyor", 0, 26.6144, 0.26, 5.52845, 84, 4635728)
	...
	spawnMobile("rori", "trainer_dancer", 0, -3.3, -0.9, 5.7, 179, 155) --Restuss
...
--	spawnMobile("rori", "trainer_entertainer", 0, 28, 2.1, 73, 270, 4635754)
	...
	spawnMobile("rori", "trainer_entertainer", 0, -5.3, -0.9, 5.7, 270, 155) --Restuss
	spawnMobile("rori", "trainer_imagedesigner", 0, -21.5126, 2.12878, 74.0536, 181, 4635404)
	spawnMobile("rori", "trainer_imagedesigner", 0, -6.9, -0.9, 5.7, 170, 155) -- Restuss
	...
	spawnMobile("rori", "trainer_musician", 0, -4.1, -0.9, 5.7, 180, 155) --Restuss
--	spawnMobile("rori", "theater_manager", 0, 21.6954, 2.12795, 63.866, 0, 4635754)
--	spawnMobile("rori", "trainer_musician", 0, -5.3, -0.9, 5.7, 270, 155) --Restuss
