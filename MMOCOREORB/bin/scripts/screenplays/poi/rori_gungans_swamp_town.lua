...
function RoriGungansSwampTownScreenPlay:spawnMobiles()
	...
	spawnMobile("rori", "rorgungan_warchief", 360, -2020, 78.9, 3268, 5, 0)
	spawnMobile("rori", "lieutenant_ori", 360, -2013.0, 77.8, 3274.9, 0, 0)
...
--	spawnMobile("rori", "thug", 360, -2041.9, 77.7, 3338.2, -136, 0)
	...
	spawnMobile("rori", "lieutenant_heb_nee", 360, -2104.6, 77.5, 3333.8, -122, 0)
	...
	spawnMobile("rori", "captain_hassk", 360, -2087.4, 75.8, 3257.8, 123, 0)
