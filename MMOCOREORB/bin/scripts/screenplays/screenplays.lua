...
--Mandalore
--includeFile("mandalore/DarthCaedusCave.lua")
--includeFile("mandalore/MandalMotors.lua")
--includeFile("mandalore/ShadowCollectiveCave.lua")
--includeFile("mandalore/TaungWarriorBunker.lua")
--includeFile("mandalore/VizslaHideout.lua")

--Port Jato
--includeFile("port_jato/space_port_jato.lua")
--includeFile("port_jato/leave_jato.lua")
--includeFile("port_jato/enter_jato.lua")

--GCW Invasion
--includeFile("invasion/corellia_coronet_base_test.lua")
