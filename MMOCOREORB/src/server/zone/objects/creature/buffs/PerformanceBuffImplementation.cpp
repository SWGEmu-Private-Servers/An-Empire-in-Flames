...
void PerformanceBuffImplementation::activate(bool applyModifiers) {
	...
	if(type == PerformanceBuffType::DANCE_MIND) {
		...
		setAttributeModifier(CreatureAttribute::MIND, (mindStrength/10));
		...
		setAttributeModifier(CreatureAttribute::FOCUS, (focusStrength/10));
		...
		setAttributeModifier(CreatureAttribute::WILLPOWER, (willStrength/10));
