...
//		suiTrainerType->addMenuItem("@city/city:st_combatmedic", 8);
		suiTrainerType->addMenuItem("@city/city:st_commando", 8);
		suiTrainerType->addMenuItem("@city/city:st_creaturehandler", 9);
		suiTrainerType->addMenuItem("@city/city:st_dancer", 10);
		suiTrainerType->addMenuItem("@city/city:st_doctor", 11);
		suiTrainerType->addMenuItem("@city/city:st_droidengineer", 12);
		suiTrainerType->addMenuItem("@city/city:st_entertainer", 13);
		suiTrainerType->addMenuItem("@city/city:st_1hsword", 14);
		suiTrainerType->addMenuItem("@city/city:st_imagedesigner", 15);
		suiTrainerType->addMenuItem("@city/city:st_marksman", 16);
		suiTrainerType->addMenuItem("@city/city:st_medic", 17);
		suiTrainerType->addMenuItem("@city/city:st_merchant", 18);
		suiTrainerType->addMenuItem("@city/city:st_musician", 19);
		suiTrainerType->addMenuItem("@city/city:st_pistol", 20);
		suiTrainerType->addMenuItem("@city/city:st_polearm", 21);
		suiTrainerType->addMenuItem("@city/city:st_politician", 22);
		suiTrainerType->addMenuItem("@city/city:st_ranger", 23);
		suiTrainerType->addMenuItem("@city/city:st_rifleman", 24);
		suiTrainerType->addMenuItem("@city/city:st_scout", 25);
		suiTrainerType->addMenuItem("@city/city:st_smuggler", 26);
		suiTrainerType->addMenuItem("@city/city:st_squadleader", 27);
		suiTrainerType->addMenuItem("@city/city:st_surveyor", 28);
