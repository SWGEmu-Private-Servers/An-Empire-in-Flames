global_rebel_uprising_large_theater = Lair:new {
	mobiles = {
		{"lesser_prophet_of_the_light_side", 1},
		{"fbase_rebel_elite_heavy_trooper", 4}
	},
	spawnLimit = 12,
...
addLairTemplate("global_rebel_uprising_large_theater", global_rebel_uprising_large_theater)
