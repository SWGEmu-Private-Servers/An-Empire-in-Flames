...
ObjectTemplates:addTemplate(object_draft_schematic_clothing_clothing_nightsister_pants_01, "object/draft_schematic/clothing/clothing_nightsister_pants_01.iff")
