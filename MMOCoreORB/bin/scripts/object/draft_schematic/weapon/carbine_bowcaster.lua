...
object_draft_schematic_weapon_carbine_bowcaster = object_draft_schematic_weapon_shared_carbine_bowcaster:new {
   ...
   targetTemplate = "object/weapon/ranged/carbine/carbine_bowcaster.iff",

   additionalTemplates = {
             }

}
ObjectTemplates:addTemplate(object_draft_schematic_weapon_carbine_bowcaster, "object/draft_schematic/weapon/carbine_bowcaster.iff")
