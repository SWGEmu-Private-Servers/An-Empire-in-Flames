...
object_tangible_component_armor_armor_segment_basic = object_tangible_component_armor_shared_armor_segment_basic:new {
...
ObjectTemplates:addTemplate(object_tangible_component_armor_armor_segment_basic, "object/tangible/component/armor/armor_segment_basic.iff")
