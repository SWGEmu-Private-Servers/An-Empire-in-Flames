...
object_tangible_component_armor_armor_segment_laminated = object_tangible_component_armor_shared_armor_segment_laminated:new {
	...
	experimentalMin = {0, 0, 1000, 1, 1000, 5, 5, 5, 1, 511, 0, 100},
	experimentalMax = {0, 0, 1000, 1, 10000, 1, 1, 1, 1, 511, 5, 1000},
	experimentalPrecision = {0, 0, 0, 10, 0, 0, 0, 0, 0, 0, 10, 0},
	experimentalCombineType = {0, 0, 1, 1, 1, 1, 1, 1, 4, 4, 4, 1},
}

ObjectTemplates:addTemplate(object_tangible_component_armor_armor_segment_laminated, "object/tangible/component/armor/armor_segment_laminated.iff")
