...
object_tangible_component_weapon_pistol_barrel_jacketed = object_tangible_component_weapon_shared_pistol_barrel_jacketed:new {
...
ObjectTemplates:addTemplate(object_tangible_component_weapon_pistol_barrel_jacketed, "object/tangible/component/weapon/pistol_barrel_jacketed.iff")
