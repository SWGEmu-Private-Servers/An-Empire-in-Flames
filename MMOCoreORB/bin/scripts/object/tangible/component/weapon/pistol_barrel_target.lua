...
object_tangible_component_weapon_pistol_barrel_target = object_tangible_component_weapon_shared_pistol_barrel_target:new {
...
ObjectTemplates:addTemplate(object_tangible_component_weapon_pistol_barrel_target, "object/tangible/component/weapon/pistol_barrel_target.iff")
