...
object_tangible_component_weapon_rifle_barrel_jacketed = object_tangible_component_weapon_shared_rifle_barrel_jacketed:new {
...
ObjectTemplates:addTemplate(object_tangible_component_weapon_rifle_barrel_jacketed, "object/tangible/component/weapon/rifle_barrel_jacketed.iff")
