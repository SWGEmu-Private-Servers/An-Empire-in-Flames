...
object_tangible_component_weapon_rifle_barrel_target = object_tangible_component_weapon_shared_rifle_barrel_target:new {
...
ObjectTemplates:addTemplate(object_tangible_component_weapon_rifle_barrel_target, "object/tangible/component/weapon/rifle_barrel_target.iff")
