...
object_tangible_wearables_cape_cape_feathered = object_tangible_wearables_cape_shared_cape_feathered:new {
	playerRaces = { 
...
ObjectTemplates:addTemplate(object_tangible_wearables_cape_cape_feathered, "object/tangible/wearables/cape/cape_feathered.iff")
